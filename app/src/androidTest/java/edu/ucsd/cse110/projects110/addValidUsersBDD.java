...
public class addValidUsersBDD {
    ...
    public void addValidUsersBDD() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.enterName), withText("Ryan"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textInputEditText2 = onView(
                allOf(withId(R.id.input_new_note_title), withText("foo"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.textInputLayout),
                                        0),
        ...
        ViewInteraction textInputEditText3 = onView(
                allOf(withId(R.id.input_new_note_title), withText("foo"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText3.perform(replaceText("sdsu"));
        ...
        ViewInteraction textInputEditText6 = onView(
                allOf(withId(R.id.input_new_note_title), withText("sdsu"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText6.perform(replaceText("lego"));
