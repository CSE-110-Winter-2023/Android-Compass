...
public class Milestone2SystemTest2 {
    ...
    @Test
    public void milestone2SystemTest2() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.counter), withText("Displaying 500+ Mile Radius"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("Displaying 500+ Mile Radius")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.CurrUserName), withText("Your online name is 'Daniel'- share this with your friends!"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView2.check(matches(withText("Your online name is 'Daniel'- share this with your friends!")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.textView3), withText("GPS Signal Active"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView3.check(matches(withText("GPS Signal Active")));

        ViewInteraction textView4 = onView(
                allOf(withId(R.id.curr_Orientation), withText("Current Orientation: -0.00"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView4.check(matches(withText("Current Orientation: -0.00")));
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.input_new_note_title),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText.perform(replaceText("lego"), closeSoftKeyboard());
